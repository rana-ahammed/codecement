    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2">
        ...
        <CldUploadButton
          ...
          className={`h-48 bg-slate-100 border-2 border-dotted grid place-items-center rounded-md relative ${
        ...
        {publicId && (
          <button
            onClick={removeImage}
            className="bg-red-500 text-white font-bold rounded-md px-4 py-2 w-fit"
          >
            Remove Image
          </button>
        )}
